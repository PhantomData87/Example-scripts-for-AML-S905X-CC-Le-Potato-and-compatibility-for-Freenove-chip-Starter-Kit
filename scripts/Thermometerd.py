...
#############################################################################
# Filename      : ADCd.py
# Description   : Using smbus on Libreboard without needing to install "ADCDevice.py" to read a thermistor
...
def run():
	...
	while True:
		...
		Rt = 10 * voltage / (3.3 -voltage) # Obtain resistance value of thermistor
		tempK = 1/(1/(273.15+25) + math.log(Rt/10)/3950.0) # Temp in Kelvin
		tempC = tempK - 273.15 # Temp in Celsius
